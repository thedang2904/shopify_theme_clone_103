...
function openNav() {
  ...
  document.getElementById("mySidenav").style.boxShadow = "0 10rem 10rem 20rem rgba(0,0,0,0.3)";

}

function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
  document.getElementById("mySidenav").style.boxShadow = "0 10rem 10rem 20rem rgba(0,0,0,0)";
}
...
window.onscroll = function() {
  ...
  if (prevScrollpos > currentScrollPos) {  
    ...
    this.document.getElementById("navbar").style.zIndex="100";
  } else {   
    document.getElementById("navbar").style.opacity="0";
    this.document.getElementById("navbar").style.zIndex="0";
  }
